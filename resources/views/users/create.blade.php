...
<head>
    ...
    <style>
        ...
        .create-box form {
            ...
            flex-wrap: wrap;
            gap: 20px 10px;
            /* Adding space between columns and rows */
        }

        .create-box form .form-group {
            flex: 1 1 45%;
            /* Adjusting the width to roughly 50% for each input field */
            padding: 0 10px;
            /* Adding padding inside the columns */
        }
